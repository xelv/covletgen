...
button.addEventListener('click', function(e) {
  ...
  \nI trust this message finds you well. My name is Mohammad Ali Al Maduri, and I am writing to express my sincere interest in the ${job.value} position at ${company.value}, as recently advertised. With a Bachelor's Degree in Information Systems and a solid background in evaluating software quality through manual and automation testing, I am eager to contribute my skills and experiences to your esteemed team.
